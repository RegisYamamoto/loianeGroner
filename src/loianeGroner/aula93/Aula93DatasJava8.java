...
// Data no Java 8+: LocalDate, LocalDateTime, LocalTime, ZoneDateTime
...
public class Aula93DatasJava8 {
	...
	public static void main(String[] args) {
		...
		System.out.println(LocalDateTime.of(2019, 2, 28, 19, 46, 50));
		System.out.println(LocalDateTime.parse("2019-02-28T19:46:50"));
		...
		ZonedDateTime zdt = ZonedDateTime.of(LocalDateTime.parse("2019-02-28T19:46:50"), sp);
		System.out.println(zdt);
		System.out.println(ZonedDateTime.parse("2019-02-28T19:46:50-03:00[America/Sao_Paulo]"));
